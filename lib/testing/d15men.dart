            ...
            child: Column(
              children: [
                ...
                _buildTestCard(
                  ...
                  subtitle: "Red Vision",
                  description:
                      "Evaluates ability to distinguish red hues. Detects L-cone (red) deficiencies.",
                ...
                _buildTestCard(
                  ...
                  description:
                      "Evaluates ability to distinguish green hues. Detects M-cone (green) deficiencies.",
                  icon: Icons.visibility,
                  fontSize: fontSize,
                ...
                _buildTestCard(
                  ...
                  description:
                      "Evaluates ability to distinguish blue hues. Detects S-cone (blue) deficiencies.",
                  icon: Icons.visibility,
                  fontSize: fontSize,
