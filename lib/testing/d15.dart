...
class D15TestScreen extends StatefulWidget {
  ...
  const D15TestScreen({super.key, required this.testType});
                    ...
                    builder:
                        (_) => Dialog(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/game_logos/d15_tutorial.png',
                              fit: BoxFit.contain,
                            ),
                          ),
                        ),
              ...
              child: IconButton(
                ...
                onPressed: () {
                  ...
                  switch (widget.testType) {
                    case D15TestType.protan:
                      testSpecificInfo =
                          "This test evaluates your ability to distinguish between 15 red hues from light pink to deep maroon.";
                      break;
                    case D15TestType.deutan:
                      testSpecificInfo =
                          "This test evaluates your ability to distinguish between 15 green hues from light mint to deep forest.";
                      break;
                    case D15TestType.tritan:
                      testSpecificInfo =
                          "This test evaluates your ability to distinguish between 15 blue hues from light sky to deep navy.";
                      break;
                  }
                  showDialog(
                    context: context,
